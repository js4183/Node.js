...
console.log("searchParams : ", myURL.searchParams.get("query")); // 특정 키의 값
...
console.log("searchParams.values() : ", myURL.searchParams.values()); //쿼리의 모든 벨류값
...
console.log(myURL.searchParams.getAll("key")); // 비어있는값
